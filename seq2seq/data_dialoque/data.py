  ...
  for i in range(5):
    if miss==False:
      ...
      if ((replica[13:14]=="1" and replica_next[13:14]=="1") or (replica[13:14]=="2" and replica_next[13:14]=="2")):
        if (replica[13:14]=="1"):
          final_text+= replica[15:]  + ". " + replica_next[15:] + "\n"
          last = replica[13:14]
...
def process_data(dataset):
    ...
    for input, output in dataset.iterrows():
        filtered_dataset.append(change_all_user_fields_qa(output["dialogue"]))

    lines = read_lines(filtered_dataset)
...
dataset = pd.read_table('data/dialogues.tsv')
